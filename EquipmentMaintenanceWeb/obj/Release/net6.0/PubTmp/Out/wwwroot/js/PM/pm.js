                ...
                "render": function (data) {
                    ...
                    `
                        <div class="w-75 btn-group" role="group">
                            <a  href="/Customer/PM/Complete?id=${data.id}&RoutineId=${data.workOrderRoutineId}"
                                class="btn btn-sm " style="background-color: #50c878;"> <i class="bi bi-play-btn"></i></a>
                        </div>
                    `
                },
                "width": "8%",
